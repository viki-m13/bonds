...
- SHORT (HL era): corr(ours, vol) = **+0.21**
...
|---|---|---|---|---|---|
| SHORT (HL era) | +1.46 | +1.66 | **+2.01** | +24% | -8% |
| LONG (2018-2026) | +1.37 | +2.01 | **+2.17** | +25% | -8% |
...
- **Diversification is genuine and strong** (corr +0.22 long / +0.21 short). Their intraday directional book (corr-to-BTC -0.11) and our daily cross-sectional book are different alphas — and both are individually good.
- **The 50/50 blend reaches ~+2.17 long (2018-26) / +2.01 short (HL era)** using the vol repo's leakage-free published series (1.99) and our ~1.5 — a real lift over either alone, because near-zero correlation makes the Sharpes add nearly in quadrature.
