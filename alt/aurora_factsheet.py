"""Build aurora_factsheet_data.json from saved aurora_returns.csv.

Output matches the schema expected by docs/aurora.html (same schema as
docs/blend.html — etf/dollar/price in allocations).
"""
import json
...
ETF_META = {
    "JEPI":  ("JPMorgan Equity Premium Income ETF", "Covered-call S&P 500 income", "Covered Call"),
    "JEPQ":  ("JPMorgan Nasdaq Equity Premium Income ETF", "Covered-call NDX income", "Covered Call"),
    "SPYI":  ("Neos S&P 500 High Income ETF", "Covered-call SPX income", "Covered Call"),
    "DIVO":  ("Amplify CWP Enhanced Dividend Income ETF", "Dividend + covered calls", "Covered Call"),
    "DBMF":  ("iMGP DBi Managed Futures Strategy ETF", "CTA trend replication", "Managed Futures"),
    "CTA":   ("Simplify Managed Futures Strategy ETF", "Multi-strategy CTA", "Managed Futures"),
    "KMLM":  ("KFA Mount Lucas Managed Futures Index ETF", "MLM commodity/FX trend", "Managed Futures"),
    ...
    "TMF":   ("Direxion Daily 20+ Year Treasury Bull 3X", "3x long-duration treasuries", "3x Leveraged"),
...
if __name__ == "__main__":
    print("Factsheet builder ready (run aurora_factsheet_run.py to execute)")
